...
function rememberMyFilms() {
    for (let i = 0; i < 2; i++) {
        ...
        if(film != null && rateOfFilm != null && film != '' && rateOfFilm != '' && film.length < 50) {
            personalMovieDB.movies[film] = rateOfFilm;
            console.log("done");
        } else {
            console.log("error");
            i--;
...
function writeYourGenres() {
    for(let i = 1; i <= 3; i++) {
        ...
        if(favoriteGenre != null && favoriteGenre != '' && favoriteGenre.length < 50) {
